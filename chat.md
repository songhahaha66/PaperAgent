...
[songhahaha66][08-20 16:00:42]：项目规则文件：project_rule.md，请仔细阅读。你需要继续完成新的任务：现在在创建项目时要选用模板，但未真正使用，请你真正将模板系统使用，先给我一个解决方案，再做修改
...
[songhahaha66][08-19 00:04:21]:未找到父章节: 研究方法 原文是**研究方法 (Methodology / Methods)** 并且你这个更新把paper.md整个文件内容变成了未找到父章节: 研究方法，你写的代码太糟糕了 
[songhahaha66][08-20 01:04:21]:项目规则文件：project_rule.md，请仔细阅读。你需要继续完成新的任务：Sidebar点击收起按钮后侧边栏比较空，加上一个创建的按钮，左下角再加一个头像
[songhahaha66][08-20 01:14:14]:你根本没有修复问题，你只是加了一堆没用的代码，现在是没有正确写入文件
[songhahaha66][08-20 01:24:21]:现在模板系统主要是一堆标题（即 #）你要有工具给ai提取标题喂给她，告诉他按格式来，总之现在你要让ai很便利的操纵模板
[songhahaha66][08-20 01:34:59]:项目规则文件：project_rule.md，请仔细阅读。你需要继续完成新的任务：现在图片预览有问题，是前端的问题，没有把请求发送给后端，仔细找一下
[songhahaha66][08-20 01:44:59]:实现伪静态
[songhahaha66][08-20 02:44:59]:项目规则文件：project_rule.md，请仔细阅读。你需要继续完成新的任务：现在在创建项目时要选用模板，但未真正使用，请你真正将模板系统使用，先给我一个解决方案，再做修改
[songhahaha66][08-20 08:04:21]:现在生成标题api跟ws聊天没办法同步进行，顺序是先生成标题，完毕后再进入ws，然后再title设置标题，这是为什么
[songhahaha66][08-20 11:08:33]:项目规则文件：project_rule.md，请仔细阅读。你需要继续完成新的任务：分析现在work界面图片预览的后端逻辑
[songhahaha66][08-20 13:08:33]:现在新建项目的时候没有把模板文件复制过去
[songhahaha66][08-20 14:08:33]：项目规则文件：project_rule.md，请仔细阅读。你需要继续完成新的任务：introduction界面来加上logo
[songhahaha66][08-20 20:33:52]：项目规则文件：project_rule.md，请仔细阅读。你需要继续完成新的任务：修改README，请基于最新架构，根据最新代码来：清晰阐述项目创意、实现功能、运行/部署指南。

[user][12-20 15:30:00]:项目规则文件：project_rule.md，请仔细阅读。你需要继续完成新的任务：现在在创建项目时要选用模板，请你支持一个不选择模板，全面修改